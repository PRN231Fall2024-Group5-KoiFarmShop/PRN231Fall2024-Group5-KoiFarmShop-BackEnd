...
namespace Koi.Repositories.Entities
{
    public class WalletTransaction : BaseEntity
    {
        ...
        public Int64 Amount { get; set; }  // Số tiền giao dịch
        public Int64 BalanceBefore { get; set; }  // Số dư trước khi giao dịch
        public Int64 BalanceAfter { get; set; }  // Số dư sau khi giao dịch
