...
namespace Koi.Repositories.Migrations
{
    ...
    [Migration("20241030062239_StaffId_Orderdetails")]
    partial class StaffId_Orderdetails
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Koi.BusinessObjects.Diet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Koi.BusinessObjects.KoiDiary", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Koi.BusinessObjects.KoiFishImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Koi.BusinessObjects.Order", b =>
                {
                    ...
                    b.Property<long>("IncompleteAmount")
                        .HasColumnType("bigint");

                    b.Property<bool?>("IsConsignmentIncluded")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Koi.BusinessObjects.OrderDetail", b =>
                {
                    ...
                    b.HasIndex("ConsignmentForNurtureId");
            ...
            modelBuilder.Entity("Koi.BusinessObjects.WithdrawnRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Koi.BusinessObjects.KoiFish", b =>
                {
                    b.HasOne("Koi.BusinessObjects.User", "Owner")
                        .WithMany("OwnerKoiFishes")
            ...
            modelBuilder.Entity("Koi.BusinessObjects.OrderDetail", b =>
                {
                    b.HasOne("Koi.BusinessObjects.ConsignmentForNurture", "ConsignmentForNurture")
                        .WithMany()
                        .HasForeignKey("ConsignmentForNurtureId");
            ...
            modelBuilder.Entity("Koi.BusinessObjects.WalletTransaction", b =>
                {
                    b.HasOne("Koi.BusinessObjects.Order", "Order")
                        ...
                        .HasForeignKey("Koi.BusinessObjects.WalletTransaction", "OrderId");
            ...
            modelBuilder.Entity("Koi.BusinessObjects.KoiFish", b =>
                {
                    ...
                    b.Navigation("KoiDiaries");

                    b.Navigation("KoiFishImages");
                });
